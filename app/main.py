...
app = FastAPI(
    ...
    version="2.5.0",
    description="Unified situational awareness, fusion, cross-source correlation, exposure enrichment, live Canadian feed ingestion, mission packs and human-authorized decision intelligence",
)
